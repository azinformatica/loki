...
import AzReorderable from './AzReorderable'
import Vue from 'vue'
...
describe('AzReorderable', () => {
    ...
    it('should initialize Sortable when component is mounted', async () => {
        const spy = jest.spyOn(AzReorderable.methods, 'initSortable')
        wrapper = shallowMount(AzReorderable, {
            localVue,
            vuetify,
            propsData,
            slots: {
